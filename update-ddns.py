#!/usr/bin/env python
"""
Code to use the Cloudflare API wrapper to update a dynamic dns record

Pulled from https://github.com/cloudflare/python-cloudflare/blob/master/examples/example_update_dynamic_dns.py
with some modifications to work more effectively in a docker environment
"""
...
def main():
    ...
    try:
        ...
        dns_name  = os.environ['CLOUDFLARE_DDNS_URL']
    except KeyError:
        exit('Please provide the CLOUDFLARE_API_TOKEN and CLOUDFLARE_DDNS_URL env variables')
